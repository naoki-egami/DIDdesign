...
If a user wish to create custom figures, data used to generate the above plot are available via
`check_panel$plot[[1]]$dat_plot` and `check_panel$plot[[2]]$dat_plot`.
