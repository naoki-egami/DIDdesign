...
did_check_std <- function(
  ...
  ## --------------------------------------------
  did_placebo_est <- did_std_placebo(
    fm_prep$fm_did[[1]], dat_did, option$lag, skip_standardize
  )
...
did_std_placebo <- function(formula, data, lags, skip_standardize) {
  ...
  for (i in 1:length(lags)) {
    ...
    dat_use$outcome <- (dat_use$outcome - ct_outcome_mean) / ct_outcome_sd
